    ...
    public partial class moddb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Comodida__A95B74EAEBFAC6CB", x => x.idComodidades);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Habitaci__7F71298BAFDC4AEA", x => x.idHabitacion_comodidades);
                    table.ForeignKey(
                        name: "FK_Habitacion_Comodidades_Comodidades",
                        column: x => x.idComodidades,
                        principalTable: "Comodidades",
                        principalColumn: "idComodidades");
                    table.ForeignKey(
                        name: "FK_Habitacion_Comodidades_Habitacion",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDRol = table.Column<int>(type: "int", nullable: false),
                    NumeroTelUsuario = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDServicio_Paquete = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDServicio = table.Column<int>(type: "int", nullable: false),
                    IDPaquete = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Servicio__C0383A8F3CAD24C0", x => x.IDServicio_Paquete);
                    table.ForeignKey(
                        name: "FK_ServicioPaquete_Paquete",
                        column: x => x.IDPaquete,
                        principalTable: "Paquete",
                        principalColumn: "IDPaquete");
                    table.ForeignKey(
                        name: "FK_ServicioPaquete_Servicio",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Servicio_Paquete_IDPaquete",
                table: "Servicio_Paquete",
                column: "IDPaquete");

            migrationBuilder.CreateIndex(
                name: "IX_Servicio_Paquete_IDServicio",
                table: "Servicio_Paquete",
                column: "IDServicio");
